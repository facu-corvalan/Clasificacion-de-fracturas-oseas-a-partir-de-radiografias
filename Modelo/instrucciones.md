...
Para el armado del siguiente modelo se utilizó un modelo de deteccion de objetos preentrenado llamado Faster R-CNN inception ResNet V2 de https://github.com/tensorflow/models/tree/master.
